...
void setup() {
  ...
  WiFi.mode(WIFI_STA);  // Ensure WiFi in Station/Client Mode
	...
	initCloudConfig("HostName=pltkdpepliot2016.azure-devices.net;DeviceId=esp826612E-1;SharedAccessKey=q5MDAjEkVJFBrfTP4yMYreENv0XPISY5FvrYiy9eDfA=", "CBA_F1", "bgh12QW2", "Piastow");
